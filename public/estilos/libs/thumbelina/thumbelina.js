...
;(function($) {
    $.fn.Thumbelina = function(settings) {
        ...
        var alto= $list.find('li').height();
        console.log('alto ul ',alto);
        $list.addClass('thumbelina').wrap('<div style="position:relative;overflow:hidden;width:100%;height:'+alto+'px;">');
