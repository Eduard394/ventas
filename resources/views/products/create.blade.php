          ...
          <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="col-sm-6">
                ...
                <input type="number" class="form-control" name="precio" id="precio" placeholder="1250">
              </div>
              <br>
              <div class="col">
              ...
              <div class="card bg-light">
                <div class="card-header d-flex p-2">
                  <h3 class="card-title p-2 text-morado-white">
                    ...
                    <h4 align="center" class="text-morado-white">Lista de Productos</h4>
                  </h3>
                </div>
                <br>
                <div class="col-sm-12">
                      ...
                      <template>
                        <b-table id="table" :fields="fields" :items="datos">
                          <template slot="nombre" slot-scope="data">
                           <tr> <a href="/precio"> <button type="submit" class="btn btn-info" ></button></a></tr>
                          </template>
                        </b-table>
                      </template>
                    </div>
    ...
    methods: {
      guardar: function() {
        ...
        axios.post(url, {
          ...
          toastr.success('Producto ' + response.data + ' resgistrado exitosamente');
          this.getData();
        }).catch(error => {
